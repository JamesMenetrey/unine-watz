...
This is a modified version on the [open-source simple neural network library Genann](https://github.com/codeplea/genann), adapted to be compiled in WASM+WASI, while receiving its dataset for example 4 using the remote attestation mechanism of WaTZ.
This work is based on the commit [#4f72209](https://github.com/codeplea/genann/commit/4f72209510c9792131bd8c4b0347272b088cfa80).
